function showTime() { 
	...
	var startDate = new Date(2018, 01, 21);
	...
	var currentTimeString = "某人:<br>"
		...
		+	"<c style=\"color: #CCCCCC; text-shadow:2px 3px 3px #222; font-family:Microsoft YaHei; font-size:20px\" >----某人  </c>"; 
